...
inline static uint32_t mx_round_to_multiples(uint32_t cnt, uint32_t n)
{
    return (cnt + (n - 1)) & (~(n - 1));
} // mx_round_to_multiples

inline static uint32_t mx_round_to_multiples_of_8(uint32_t cnt)
{
    return (cnt + (8 - 1)) & (~(8 - 1));
} // mx_round_to_multiples_of_8

inline static uint32_t mx_round_to_multiples_of_16(uint32_t cnt)
{
    return (cnt + (16 - 1)) & (~(16 - 1));
} // mx_round_to_multiples_of_16
